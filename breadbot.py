...
# configure OpenAI
openai.api_key = os.getenv=("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")

INSTRUCTIONS = """<<You are an expert on making all types of bread. You know the ingredients, amounts for recipies, how to make them and how long it might take. Give the answers in Russin if asked. >>q
"""
ANSWER_SEQUENCE = "\nAI:"
QUESTION_SEQUENCE = "\nHuman: "
TEMPERATURE = 0.5
