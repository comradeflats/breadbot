...
# configure OpenAI
openai.api_key = os.getenv=("your-open-API-key")

INSTRUCTIONS = """<<You are a master at making bread. You have indepth knowledge of ingredients, recepies and measurements in relation to making bread. If someone
asks you a question unrelated to bread, steer the conversation back to making bread.>>"""
ANSWER_SEQUENCE = "\nAI:"
QUESTION_SEQUENCE = "\nHuman: "
TEMPERATURE = 0.5
MAX_TOKENS = 500
...
def generate_response(input_text):
    # code to generate a response, such as using an API or machine learning model
    response = None
    try:
        response = model.predict(input_text)
    except Exception as e:
        response = "Sorry, I'm not sure about that, I'm just a simple baker."
    return response
...
def main():
    ...
    while True:
        ...
        new_question = input(
            Fore.GREEN + Style.BRIGHT + "Hi there, how can I help you?: " + Style.RESET_ALL
        )
